        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="row mt-4">
                    ...
                    <div class="col-6">
                        <div class="card">
                            <img class="card-img-top" src="{{ custom_asset($productItem->image_image) }}" alt="Card image cap">
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.product.create', ['product_type' => 'image']) }}"
                                    class="btn btn-primary">{{ __('admin.Go to create page') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <img class="card-img-top" src="{{ custom_asset($productItem->video_image) }}"
                                alt="Card image cap">
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.product.create', ['product_type' => 'video']) }}"
                                    class="btn btn-primary">{{ __('admin.Go to create page') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <img class="card-img-top" src="{{ custom_asset($productItem->audio_image) }}"
                                alt="Card image cap">
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.product.create', ['product_type' => 'audio']) }}"
                                    class="btn btn-primary">{{ __('admin.Go to create page') }}</a>
                            </div>
                        </div>
                    </div>
