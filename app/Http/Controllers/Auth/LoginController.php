...
class LoginController extends Controller
{
    ...
    public function translator()
    {
        ...
        // If no default language found, fall back to config app.locale
        if (!$language) {
            $front_lang = config('app.locale');
            Session::put('front_lang', $front_lang);
    ...
    public function loginPage(){
        ...
        $login_page = array(
            'image' => $setting->login_image ?? null // or provide a default image path
        );
